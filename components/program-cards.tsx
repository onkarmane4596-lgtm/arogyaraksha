...
const programs = [
    {
        ...
        timing: "6:10 AM – 9:30 AM | 12:00 PM | 6:00 PM",
        duration: "Online + Offline",
        description: "A complete wellness journey including Asana, Pranayama, Meditation, and Cleansing. Plus Zumba, Aerobics, Vajra Moves, Strength Training, and Special Wellness Sessions.",
        image: "/images/programs/programs-hero.jpg",
        features: ["Asana, Pranayama & Meditation", "Cleansing & Special Sessions", "Zumba, Aerobics & Strength"],
        icon: Users,
        whatsappMsg: "Hello! I am interested in joining the Regular Yoga Practice Batch. Could you please share the details regarding the available timings and the enrollment process? Thank you!",
    },
    {
        title: "PCOD / PCOS Weight Loss",
        timing: "9:30 AM – 10:30 AM",
        duration: "100% Online",
        description: "Specially designed for women to support hormonal balance and metabolism. Includes fat-burning asanas, hormone-balancing pranayama, and lean muscle strength training.",
        image: "/images/programs/pcos-therapy-new.png",
        features: ["Fat-burning Yoga Asanas", "Hormone-balancing Pranayama", "Strength Training & Metabolic Reset"],
        icon: Activity,
    ...
    },
    {
        ...
        duration: "Online + Offline",
        description: "Safe, slow-paced yoga designed for seniors. Focuses on knee and back pain relief, mobility, and balance restoration with optional chair support for maximum comfort.",
        image: "/images/programs/senior-yoga-new.png",
        features: ["Knee & Back Pain Relief", "Chair Support Options", "Safe Mobility & Balance"],
        icon: Heart,
    ...
    },
    {
        ...
        duration: "21 Days",
        description: "Short, powerful, result-oriented program for tummy, arms, and thigh fat reduction. Includes core tightening and safe postpartum/Diastasis Recti recovery exercises.",
        image: "/images/programs/weight-loss-new.png",
        features: ["Targeted Fat Reduction", "Postpartum & DR Recovery", "Visible Inch Loss Focus"],
        icon: Dumbbell,
