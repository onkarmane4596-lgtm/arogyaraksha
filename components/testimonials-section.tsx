...
export function TestimonialsSection() {
  return (
    <section className="py-16 md:py-32 bg-background relative overflow-hidden flex flex-col items-center">
      ...
      <div className="container relative z-10 max-w-7xl px-4 sm:px-6 md:px-8">
        ...
        <div className="mb-12 md:mb-20 space-y-4 md:space-y-6 max-w-2xl">
          <motion.span
          ...
          <motion.h2
            ...
            className="font-sans font-bold text-3xl sm:text-4xl md:text-5xl lg:text-7xl text-heading leading-[1.1] tracking-tight"
          >
            Community <br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 space-y-4">
            <motion.div
              ...
              className="bg-card relative overflow-hidden group p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] shadow-xl shadow-primary/5 border border-primary/10"
            >
              ...
              <div className="flex items-center gap-4 pt-6 md:pt-8 border-t border-primary/10">
                <div className="flex -space-x-3 md:-space-x-4">
                  ...
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center bg-primary/10 text-primary font-bold text-[10px] md:text-xs border-[3px] md:border-4 border-card shadow-sm">
                    +280
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6 pt-6">
              ...
              >
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-3 px-8 py-5 bg-primary text-white rounded-2xl font-bold uppercase tracking-widest text-xs shadow-xl shadow-primary/20 hover:bg-primary/90 transition-all hover:-translate-y-1"
                >
          ...
          <div className="lg:col-span-7 columns-1 md:columns-2 gap-4 sm:gap-6 md:gap-8">
            {reviews.map((review, index) => (
              <motion.div
                ...
                className="break-inside-avoid mb-4 sm:mb-6 md:mb-8 bg-card p-5 sm:p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] shadow-md shadow-primary/5 border border-primary/10 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/10 transition-all duration-500 group"
              >
                <div className="flex items-center justify-between mb-4 md:mb-6">
                  <div className="flex items-center gap-3 md:gap-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-[0.8rem] md:rounded-2xl bg-primary/10 flex items-center justify-center text-primary font-bold text-lg md:text-xl shrink-0 group-hover:bg-primary group-hover:text-white transition-colors duration-500">
                      {review.avatar}
                    </div>
                    <div>
                      <h4 className="font-bold text-heading text-[15px] md:text-base tracking-tight">{review.name}</h4>
                      <p className="text-[10px] md:text-xs text-primary/60 uppercase tracking-widest font-bold">{review.date}</p>
                    </div>
                  </div>
                  <div className="opacity-30 group-hover:opacity-60 transition-opacity">
                    <svg viewBox="0 0 24 24" className="w-[18px] h-[18px] md:w-[22px] md:h-[22px]" xmlns="http://www.w3.org/2000/svg"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4" /><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853" /><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05" /><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335" /></svg>
                  </div>
                </div>
                ...
                <p className="text-foreground/80 text-[14px] md:text-base leading-relaxed font-light">
                  "{review.text}"
                </p>
